...
class MexcOrderBookTests(TestCase):
    ...
    def test_diff_message_from_exchange(self):
        ...
        # update_id should use toVersion for sequencing, not timestamp
    ...
    def test_diff_message_includes_first_update_id(self):
        """first_update_id must be populated from fromVersion."""
        diff_msg = MexcOrderBook.diff_message_from_exchange(
            msg={
                "publicAggreDepths": {
                    "bids": [],
    ...
    def test_diff_message_falls_back_to_timestamp_when_no_version(self):
        """When no version fields, fall back to timestamp."""
        diff_msg = MexcOrderBook.diff_message_from_exchange(
            msg={
                "publicAggreDepths": {
                    "bids": [],
        ...
        self.assertEqual(99999.0, diff_msg.update_id)
