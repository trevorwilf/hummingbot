<#
  run_hbtriage_engine_batch.ps1 -- unattended phased IMPLEMENTATION runner with cross-family review.
  Run A of the hb_predeploy triage fix batch: ENGINE repo (E:/tradingsoftware/hummingbot), base nonkyc.
  ...
  Launch:  powershell -ExecutionPolicy Bypass -File .\run_hbtriage_engine_batch.ps1
  Smoke:   powershell -ExecutionPolicy Bypass -File .\run_hbtriage_engine_batch.ps1 -SmokeTest
  Full:    add -SmokeFull to smoke the REAL configured models, premium ones included.
...
# ---------------- config (hbtriage_engine / Run A) ----------------
$Repo          = "E:/tradingsoftware/hummingbot"
$Name          = "hbtriage_engine"
$PromptFile    = "hbtriage_engine_batch_prompt.md"
$NumImplPhases = 6                        # finalization is phase 7
$BranchPrefix  = "fix/hbtriage-p"         # verified: matches NO existing ref in this repo
...
$ReportFile    = "REPORT_hbtriage_engine.md"
...
# Per-phase plans (1=CDX-002 cutover, 2=CDX-008 id, 3=CDX-007 path, 4=CDX-009 gateway,
# 5=CDX-010 controllers-dest, 6=doc corrections, 7=finalization).
$PhaseEffort       = @{ 1='xhigh'; 2='medium'; 3='high'; 4='high'; 5='high'; 6='medium'; 7='medium' }
$PhaseModel        = @{ 1=$OPUS; 2=$OPUS; 3=$OPUS; 4=$OPUS; 5=$OPUS; 6=$OPUS; 7=$SONNET }
$PhaseReviewEffort = @{ 1='high'; 2='high'; 3='high'; 4='high'; 5='high'; 6='medium' }
$PhaseReviewModel  = @{ 1=$GPT56; 2=$GPT56; 3=$GPT56; 4=$GPT56; 5=$GPT56; 6=$GPT56 }
...
# model quality; premium models are stood down to a cheap SAME-FAMILY stand-in.
...
Log ("=== BATCH COMPLETE. Read {0} first (its REVIEW LEDGER + REQUIRES HUMAN ARBITRATION sections), then {1}/ and batch_logs. THE HUMAN GATE: rebuild + verify runtime docker_service.py == image file BEFORE starting Run B (hummingbot-api)." -f $ReportFile,$RecordsDir)
exit 0
